(function autoexecute() {
    ...
    // set the dimensions and margins of the graph
    var marginBox = {top: 10, right: 30, bottom: 30, left: 60},
        ...
        function(d) {
            d3.select("#submit-button").on("click", 
                function () {
                    ...
                    // if (foundPermutation[1]["Hispanic"] !== '0' && foundPermutation[1]["Non-Hispanic"] !== '0') {
                        // PIE CHART 1 - HISPANIC
                        // set the color scale
                    ...
                    //         .attr("text-anchor", "middle")  
                    //         .style("font-size", "16px") 
                    //         .text("Aw, we don't have enough data!");
                    // }
